...
if plot_proj3:
    quick_plot(
        [
         'SAC UTD 1', 'SAC UTD 5', 'SAC UTD 1 + reset', 'SAC UTD 5 + reset'],
        [
            'exp_e300_q2_uf1_lr0.0003_g0.99_p0.995_ss5000_b64_h64_reset0',
            'exp_e300_q2_uf5_lr0.0003_g0.99_p0.995_ss5000_b64_h64_reset0',
            'exp_e300_q2_uf1_lr0.0003_g0.99_p0.995_ss5000_b64_h64_reset1',
            'exp_e300_q2_uf5_lr0.0003_g0.99_p0.995_ss5000_b64_h64_reset1',
        ],
        envs=envs,
        save_name='SAC_UTD_reset',
